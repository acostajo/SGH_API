...
from .serializers import TurnoDistSerializer  # este nomas era


class TurnoDistViewSet(viewsets.ModelViewSet):
    # en este obtenemos todos los objetos que hay en la bd
    queryset = TurnoDist.objects.all()
    ...
    serializer_class = TurnoDistSerializer
    ...
    filter_fields = ("codturnodist", "desturno", "horaturno")
