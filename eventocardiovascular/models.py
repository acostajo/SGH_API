...
class EventoCardiovascular(models.Model):
    ...
    codusuario = models.IntegerField(null=True) #	código interno de usuario, para saber quién agrego un evento cardiovascular
    nombre	= models.CharField(max_length=50) #nombre del evento cardiovascular, es el numobre sorry sorrry
