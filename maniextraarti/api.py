...
from .serializers import ManiExtraArtiSerializer  # este nomas era


class ManiExtraArtiViewSet(viewsets.ModelViewSet):
    # en este obtenemos todos los objetos que hay en la bd
    queryset = ManiExtraArti.objects.all()
    ...
    serializer_class = ManiExtraArtiSerializer
