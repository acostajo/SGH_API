...
class ManiExtraArti(models.Model):
   ...
   codusuario = models.IntegerField(null=True) #	código interno de usuario, para saber quién agrego una manifestación extra articular
   nombre = models.CharField(max_length=50) 	#nombre de la manifestación extra articular
   descripcion	= models.CharField(max_length=50, null = True, blank=True) 	#descripción de la manifestación extra articular
